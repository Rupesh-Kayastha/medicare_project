...
class HospitalController extends Controller
{
    ...
    public function actionCreate()
    {
        ...
        if ($model->load(Yii::$app->request->post()) && $model->save()) {
            Yii::$app->session->setFlash('success', "Hospital Entered Successfully");
            return $this->redirect(['index', 'id' => $model->HospitalId]);
        } else {
    ...
    public function actionUpdate($id)
    {
        ...
        if ($model->load(Yii::$app->request->post()) && $model->save()) {
            ...
            return $this->redirect(['view', 'id' => $model->HospitalId]);
        } else {
